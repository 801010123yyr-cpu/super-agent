 ...
 *
 * The {@link DefaultUidGenerator#parseUid(long)} is a super agent method to parse the bits
 *
 * <pre>{@code
 * +------+----------------------+----------------+-----------+
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    /** Customer epoch, unit as second. For super agent 2024-05-20 (ms: 1716134400000)*/
