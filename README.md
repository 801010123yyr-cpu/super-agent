...
<p align="center">
  ...
  <img alt="Hybrid Search" src="https://img.shields.io/badge/Hybrid%20Search-Weighted%20Fusion-7c6ee6?style=flat-square" />
...
- 不是只用向量检索。用户问一个订单号、一个配置项名，向量检索很可能找不到。所以用了**多通道并行召回**：PGVector 向量、Elasticsearch/BM25 关键词、结构化表格、GraphRAG 实体关系与社区报告、RAPTOR 层级摘要
